...
local passwdMain = function()
  ...
  (oldHash == nil or oldHash == "") and false or (function()
    syscall[0x80](1, shellState.currentY, "Old password: ")
  ...
  syscall[0x80](1, y1, "New password: ")
  local new1 = shellReadLine(true)
  local y2 = y1 + 1
  syscall[0x80](1, y2, "Confirm new password: ")
  ...
  syscall[0x80](1, y2+1, "Password updated successfully.")
end
