-- Nyanity Modular BIOS v6.00PG (AwooOS Port)
...
local function splash(bSkipMemTest)
  ...
  gpu.set(1, 1, "BIOS v0.5, An Energy Star Ally")
  gpu.set(1, 2, "Copyright (C) 2025, awoo")
  gpu.set(1, 4, "AwooOS Kernel Processor - Tier 3 (APU)")
  ...
  gpu.set(1, h-1, "01/01/2025-AwooOS-0.21-2A69K")
  return nil
end
